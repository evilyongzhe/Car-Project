...
#import "NetDefine.h"
@implementation PredictModel (Net)
+(void)requestPage:(NSInteger)page completionBlock:(NewBlock)block{
    NSString * urlStr = [NSString stringWithFormat:kPredictUrl,(long)page];
    ...
    [manager GET:urlStr parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        NSMutableArray * newArray = [PredictModel arrayOfModelsFromDictionaries:dataArray];
