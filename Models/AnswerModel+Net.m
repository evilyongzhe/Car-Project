...
#import "NetDefine.h"
@implementation AnswerModel (Net)
+(void)requestPage:(NSInteger)page completionBlock:(Completion)block{
    NSString * urlStr = [NSString stringWithFormat:kAnswerUrl,(long)page];
    ...
    [manager GET:urlStr parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        ...
        NSMutableArray *modelArray = [AnswerModel arrayOfModelsFromDictionaries:dataArray];
        //使用block
